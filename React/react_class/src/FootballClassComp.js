...
// 클래스 컴포넌트
class FootballClassComp extends React.Component {
    constructor (props) {
        super(props)
    }
    ...
    render() {
        return (
            <button type="button" onClick={(event) => this.shoot("The tremendous Goal Son!!!", event)}>Take the shot !!</button>
        )
    }
}
...
export default FootballClassComp