...
namespace first_space
{
    void myFunc()
    {
        cout << "This function is in first_space\n" << endl; // cout만 using 선언했으니 endl는 std를 붙여줘야 한다. 
    }

    namespace second_space
    {
        void myFunc() // namespace 중첩. 같은 myFunc이지만 내용물은 다르다.
        {
...
int main()
{
    ...
    first_space::second_space::third_space::myFunc(); // 범위지정 연산자 - :: // 중첩해서 사용도 가능
    // using 지시자(directive)
